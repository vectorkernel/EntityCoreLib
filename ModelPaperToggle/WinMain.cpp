...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE /*hPrevInstance*/, PSTR /*szCmdLine*/, int /*iCmdShow*/)
{
    ...
    HWND hwnd = CreateWindowEx(
        ...
        L"ModelPaperToggle (F2 toggles Model/Paper)",
        style,
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_RBUTTONDOWN:
    {
        if (gApplication)
        {
            ...
            gApplication->OnRightButtonDownClient(x, y);
            SetCapture(hwnd);
        }
        return 0;
    }
    ...
    case WM_RBUTTONUP:
    {
        if (gApplication)
        {
            gApplication->OnRightButtonUpClient();
            ReleaseCapture();
        }
        return 0;
    }
    ...
    case WM_MOUSEMOVE:
    {
        if (gApplication)
        {
            ...
            {
                gApplication->OnRightButtonDragMoveClient(x, y);
            }
        }
        return 0;
    }
    ...
    case WM_LBUTTONUP:
    {
        // LMB up is handled by the app's selection logic (no capture needed).
        return 0;
    }
    ...
    case WM_MOUSEWHEEL:
    {
        if (gApplication)
        {
            ...
            gApplication->OnMouseWheelClient((int)pt.x, (int)pt.y, wheelDelta);
        }
        return 0;
    }
    case WM_ERASEBKGND:
