...
public:
    ...
    // -------------------------------------------------
    // Command UI integration helpers
    // -------------------------------------------------
    bool IsIdleForCommand() const { return !m_lineCommandActive; }
    bool IsLineActive() const { return m_lineCommandActive; }
    bool HasFirstPoint() const { return m_lineHasFirst; }
...
private:
    ...
    // --- LINE command + jig (model-space) ---
    bool   m_lineCommandActive = false;
    bool   m_lineHasFirst = false;
    glm::vec3 m_lineP0{0.0f};
    glm::vec3 m_lineP1{0.0f};
    bool   m_jigDirty = false;
    GLuint m_jigVbo = 0;
