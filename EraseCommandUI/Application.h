...
public:
    ...
    bool IsRectSelectionWaiting() const { return m_state.waitingForSecondClick; }
    InteractionState::RectMode CurrentRectMode() const { return m_state.rectMode; }
    bool IsRectSelectionActive() const { return m_selWindow.IsActive(); }
